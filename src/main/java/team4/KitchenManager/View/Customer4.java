...
public class Customer4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("THÔNG TIN LỊCH SỬ MUA HÀNG");

        jButton2.setBackground(new java.awt.Color(102, 102, 102));
        jButton2.setText("QUAY LẠI LỊCH SỬ MUA HÀNG");
...
this.dispose(); // giải phóng tài nguyên và đóng cửa sổ hiện tại        // TODO add your handling code here:
 new  
            Customer3
        ().setVisible(true);   
